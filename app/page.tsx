...
export default function Home() {
  return <><Header /><main id="top">
    ...
    <section className="sausage-showcase"><div className="container"><div className="sausage-heading"><div><p className="kicker dark">The heart of our range</p><h2>Proper sausages,<br />made for sharing.</h2></div><div><p>From traditional British-style bangers to lamb and chilli favourites, our halal sausages bring generous flavour to breakfasts, grills and family suppers.</p><ShopButton>Shop sausages</ShopButton></div></div><div className="sausage-gallery"><div className="sausage-tile sausage-tile-tall"><Image src="/victoria/editorial/lamb-sausages.jpg" alt="Victoria Crest lamb sausages with grilled vegetables" fill sizes="(max-width: 700px) 100vw, 40vw" className="object-cover" /></div><div className="sausage-tile"><Image src="/victoria/editorial/lamb-cranberry-sausages.jpg" alt="Victoria Crest lamb and cranberry sausages" fill sizes="(max-width: 700px) 100vw, 30vw" className="object-cover" /></div><div className="sausage-tile"><Image src="/victoria/editorial/chicken-herb-sausages.jpg" alt="Victoria Crest chicken and herb sausages" fill sizes="(max-width: 700px) 100vw, 30vw" className="object-cover" /></div><div className="sausage-tile sausage-tile-wide"><Image src="/victoria/editorial/smoked-chicken-sausages.jpg" alt="Victoria Crest smoked chicken sausages" fill sizes="(max-width: 700px) 100vw, 60vw" className="object-cover" /></div></div></div></section>

    <section id="quality" className="split-story"><div className="story-photo"><Image src="/victoria/editorial/dynamite.jpg" alt="Victoria Crest dynamite chicken sausages" fill sizes="(max-width: 900px) 100vw, 50vw" className="object-cover" /></div><div className="story-copy"><div><p className="kicker">The Victoria Crest promise</p><h2>Premium flavour.<br />No fuss.</h2><p>Victoria Crest brings Halal British comfort-food traditions to Malaysian homes. Our focus is simple: dependable quality, satisfying flavour and food the whole table can enjoy.</p><ul><li><Check /> Halal-certified production</li><li><Check /> Carefully developed recipes</li><li><Check /> Convenient frozen favourites</li></ul><ShopButton>Fill your freezer</ShopButton></div></div></section>
